...
namespace Entra21.BancoDadosAdo.net.DataBase
{
    internal class Conexao
    {
        public SqlConnection Conectar()
        {
            ...
            var connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\amanda.mota\source\repos\entra-21\ExemplosSQL\ExemploBancoDados01AdoNet.mdf;Integrated Security=True;Connect Timeout=30";
